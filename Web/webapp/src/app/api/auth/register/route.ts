...
export async function POST(req: NextRequest) {
  try {
    ...
    const backendUrl = `${apiBase}/auth/register`
    
    console.log('📝 [API Route] Proxying register request to:', backendUrl)
    ...
    try {
      ...
      console.log('✅ Successfully registered user:', data.user?.phone || data.user?.id)
    } catch (parseError) {
    ...
    console.error('❌ Error proxying register to backend:', error)
