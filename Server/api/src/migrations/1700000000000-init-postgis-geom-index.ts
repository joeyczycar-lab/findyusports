...
export class InitPostgisGeomIndex1700000000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        try {
            ...
            // Try to create PostGIS extension (with error handling)
            try {
            ...
            console.warn('⚠️  PostGIS migration failed, but continuing:', error.message)
            // Don't throw - allow migration to complete without PostGIS
        }
    }
